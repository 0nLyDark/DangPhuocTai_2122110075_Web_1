...
Route::get('/tim-kiem',[SanphamController::class,'search'])->name("site.product.search");
...
Route::get('/bai-viet/{slug}',[BaiVietController::class,'detail'])->name("site.post.detail");
...
Route::post('/lien-he/store',[LienheController::class,'store'])->name("site.contact.store");
//Cart
...
Route::get('cart/delete',[CartController::class,'deletecart'])->name("site.cart.delete");
Route::get('cart/deleteAll',[CartController::class,'deleteAllcart'])->name("site.cart.deleteAll");
Route::get('cart/checkout',[CartController::class,'checkout'])->name("site.cart.checkout");
Route::post('cart/checkout',[CartController::class,'docheckout'])->name("site.cart.docheckout");
Route::get('cart/checkout-success',[CartController::class,'successcheckout'])->name("site.cart.successcheckout");
//Login-Logout-Customer
Route::get('/dang-nhap',[CustomerController::class,'getlogin'])->name("site.customer.getlogin");
Route::post('/dang-nhap',[CustomerController::class,'dologin'])->name("site.customer.dologin");
Route::get('/dang-xuat',[CustomerController::class,'logout'])->name("site.customer.logout");
Route::get('/dang-ky',[CustomerController::class,'register'])->name("site.customer.register");
//Login-Logout-Admin
Route::get('/dang-nhap-admin',[AuthController::class,'getlogin'])->name("admin.getlogin");
Route::post('/dang-nhap-admin',[AuthController::class,'dologin'])->name("admin.dologin");
Route::get('/dang-xuat-admin',[AuthController::class,'logout'])->name("admin.logout");
//route admin
