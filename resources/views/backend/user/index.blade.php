                      ...
                      @foreach ($list as $row)
                        <tr>
                            ...
                            <td style="width: 180px" class="text-center ">
                              <a data-url="{{ route('admin.user.status',$id) }}" name="status" data-id="{{ $row->id }}" class="btn btn-sm ">
                                @if ($row->status==1)
                              ...
                              <a href="{{ route('admin.user.show',$id) }}" class="btn btn-sm ">
                                  <i class="far fa-eye text-info"></i>
                              </a> 
                              <a href="{{ route('admin.user.edit',$id) }}" class="btn btn-sm ">
                                  <i class="fas fa-edit text-primary"></i>
                              </a>
                              <a data-url="{{ route('admin.user.delete',$id) }}" name="delete" data-id="{{ $row->id }}" class="btn btn-sm ">
